...
<tr class=ho><th id="property">Property<th id="type">Type<th id="notes">Notes
<tr class=zebra><th id="command"><code>command</code><td>String<td>name of the frame (<code>"CONNECT"</code>, <code>"SEND"</code>, etc.)
<tr><th id="headers"><code>headers</code><td>JavaScript object<td>
<tr class=zebra><th id="body"><code>body</code><td>String<td>
</table>
...
<script src='http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js' integrity="sha384-xxxxx" crossorigin="anonymous"></script>
